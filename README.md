...
<img src="https://komarev.com/ghpvc/?username=ShashankJangid&style=flat-square&color=FF6B00&label=profile+views" />
...
| [**MLOps-Pipeline**](https://github.com/ShashankJangid/MLOps-Pipeline) | Production MLOps pipeline on Kaggle — DistilBERT fine-tuning on UCSD Goodreads dataset, W&B tracking, Docker serving ([Kaggle Notebook](https://www.kaggle.com/code/shashankjangid/mlops-pipeline)) | `PyTorch` `HuggingFace` `Kaggle` `W&B` `Docker` `FastAPI` |
...
<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=ShashankJangid&bg_color=0d1117&color=FF6B00&line=FF6B00&point=ffffff&area=true&hide_border=true" width="100%" />
</p>
